    ...
    <div class="row mt-3">
        <div class="col-md-7">
            <form action="{{ route('checkout.place') }}" method="POST" id="checkout-form">
                ...
                <small class="text-muted mb-3 d-block">Mỗi mã giảm giá chỉ được sử dụng 1 lần cho mỗi khách hàng.</small>
                ...
                <div id="payment-delivery">
                    ...
                    <div class="form-check"><input class="form-check-input" type="radio" name="payment_method" value="bank"> <label>Chuyển khoản ngân hàng (VietQR)</label></div>
                    <div class="form-check mb-2"><input class="form-check-input" type="radio" name="payment_method" value="vnpay"> <label>Thanh toán qua VNPay</label></div>
                </div>
